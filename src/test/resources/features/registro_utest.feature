...
Feature: Enter Utest.com
  ...
  Scenario Outline: Create a new user
    ...
    Examples:
      ...
      | Candidato    | Correa      | usuario4@hotmail.com | September | 20    | 1990   | Medellín | 05660         | Colombia  | Windows    | 10         | Spanish    | Apple    | iPhone 4 | iOS 6.1            | Kmzwayw1aalol | Kmzwayw1aalol      | Welcome to the world's largest community of freelance software testers! |